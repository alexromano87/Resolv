...
import { CheckupExportController } from './checkup-export.controller';
...
@Module({
  ...
  controllers: [CheckupExportController],
  providers: [CheckupExportService],
  exports: [CheckupExportService],
})
export class CheckupExportModule {}
